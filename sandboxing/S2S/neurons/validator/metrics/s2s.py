...
from ..utils.resource_monitor import ResourceMonitor, ResourceThresholds
...
class S2SMetrics:
    ...
    def __init__(self, metrics_config):
        ...
        self.cache_dir = "/sandbox/.cache/huggingface"
        self.models_dir = "/sandbox/model"
        ...
        self.anti_spoofing_inference = RawNet3Inference(model_name = 'jungjee/RawNet3',repo_dir = "/sandbox/model", device=self.device)
    ...
    def compute_distance(self, 
        ...
        monitor = ResourceMonitor(self.resource_thresholds)
        monitor.start()
        ...
        try:
            ...
            compute_score = [monitor.get_compute_score()]
