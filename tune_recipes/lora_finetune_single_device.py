...
class LoRAFinetuneRecipeSingleDevice(FTRecipeInterface):
    ...
    def _setup_model(
        ...
        self.base_trainable_params = {
            n: p for n, p in model.named_parameters() if n in _BASE_TRAINABLE
        }
        ...
        set_trainable_params(model, self.adapter_params | self.base_trainable_params)
        ...
        base_missing = list(set(base_missing) - set(self.base_trainable_params))
